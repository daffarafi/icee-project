  ...
  return (
    <nav className="flex fixed z-10 md:pb-1 flex-row md:flex-row w-full bg-[#cee3db] justify-between">
      <div className="flex px-2 mt-2">
        ...
        />
        <p
          className="font-Sarmandy tracking-wide text-black ml-2 font-semibold text-lg md:text-xl 
      ...
      {/* Desktop */}
      <div
        className="hidden sm:flex px-2 mt-2 md:mt-6 md:mr-10 font-Sarmandy 
      ...
      <div
        className={`fixed top-0 right-0 w-full sm:hidden h-screen bg-[#cee3db] 
            p-10 transition-transform ${
              showMobileMenu
          ...
          <ul className="flex flex-col items-center gap-16">
            <li>
              <Link
                ...
                className="text-black font-Sarmandy
                             text-3xl"
              >
                HOME
              </Link>
