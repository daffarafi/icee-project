...
export const HeroSection: React.FC = () => (
  <section id="home" className="px-5 sm:px-10 pt-16 sm:pt-20 w-full h-[90vh] bg-[#2c3531]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-5 sm:gap-10 m-4">
        <div className="flex flex-col gap-5 sm:gap-10 sm:ml-10 w-full sm:w-[60%]">
          ...
          <p className="text-base sm:text-2xl mt-10 font-thin">
            ITB Civil Engineering Expo (ICEE) is an annual event organized by the Civil Engineering Student
            Association (Himpunan Mahasiswa Sipil ITB) which is present as a forum for collaboration for
            students in developing themselves through various events that are integrated with the technical
            issues raised.
          </p>
        </div>
        <Image src="/herologo.svg"
          alt="/herologo.svg"
          width={80}
          height={40}
